const WallpaperLib = {
    ...
    getParams() {
        ...
        return {
            ...
            w: this.parseIntOrNull(urlParams.get('w')),
            h: this.parseIntOrNull(urlParams.get('h')),
    ...
    renderControls() {
        ...
        document.getElementById('apply-btn').onclick = () => {
            ...
            if (res && res !== 'custom') {
                ...
                const customW = WallpaperLib.parseIntOrNull(customWRaw);
                const customH = WallpaperLib.parseIntOrNull(customHRaw);
                if (
                    customW === null ||
                    customH === null ||
                    customW <= 0 ||
